...
- For Claude-specific CLAUDART operating-layer guidance, also follow the installable source template `.claude/CLAUDE.md` and the relevant files it routes to; downstream installs relocate that template to root `CLAUDE.md`.
