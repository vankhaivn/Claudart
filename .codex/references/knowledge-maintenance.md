...
Read this reference only when a task creates, updates, routes, normalizes, audits, or refactors `.claudart/knowledge/`. Apply the four-part classification and retrieval bounds in `.codex/guidelines/knowledge-management.md` first. This reference does not grant authority beyond the current task.
