...
This guideline is the root contract for retrieval and classification. Routine `$codex-start` reads only `.claudart/knowledge/INDEX.md`; it does not load this guideline, detail topics, domain maps, the maintenance reference, or the checker.
