...
when_to_use: Every Codex task that inspects, creates, changes, fixes, refactors, or reviews code or code-adjacent artifacts.
...
2. Applicable `AGENTS.override.md`, `AGENTS.md`, repository guidelines, tests, public contracts, and local conventions.
