---
paths: ["**/*"]
description: Universal AI execution guidelines for scoped, autonomous, evidence-driven Codex work across stacks and domains.
...
These guidelines are working when Codex asks fewer unnecessary questions, makes smaller coherent diffs, avoids speculative architecture, completes more tasks without supervision, and provides concrete evidence instead of unsupported confidence.
