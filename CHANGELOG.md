...
### Added
- Project discovery workflow: Claude `/project-discovery`, Codex `$project-discovery`, and a structured docs generation protocol for turning rough ideas into project documentation before implementation.
