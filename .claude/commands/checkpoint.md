---
description: Update .claudart/CONTEXT.md to reflect the CURRENT state of work (declarative overwrite). Append graduated items to .claudart/JOURNAL.md. Run at the end of meaningful sessions.
---
...
Add to `.claudart/CONTEXT.md` only what's true *now*:
...
For every item that was DROPPED in Step 2 because it was *done/decided/pivoted*, write **one line** to `.claudart/JOURNAL.md` in this format:
