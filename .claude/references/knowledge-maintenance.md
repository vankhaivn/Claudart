...
Otherwise preserve the observation as a candidate in its owning work artifact. `/checkpoint` performs bulk maintenance and promotion, but it is not the only write gate.
